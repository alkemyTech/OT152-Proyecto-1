...
with DAG(
    ...
    sql_universidad_flores = PythonOperator(task_id='Query_flores', python_callable=execute_queries, op_args=["flores"],
                            dag=dag)
    ...
    sql_universidad_villa_maria = PythonOperator(task_id='Query_villa_maria', python_callable=execute_queries, op_args=["villa_maria"],
                            dag=dag)
