...
with DAG(
    ...
    csv_latinoamericana = PythonOperator(task_id='create_csv_file', python_callable=query_db,
                                         op_args=['query_latinoamericana','latinoamericana'], dag=dag)
    
    csv_kennedy = PythonOperator(task_id='csv_kennedy', python_callable=query_db,
                                 op_args=['query_kenedy','kenedy'], dag=dag)
    ...
    [csv_latinoamericana >> csv_latinoamericana], [csv_kennedy>>csv_kennedy]
